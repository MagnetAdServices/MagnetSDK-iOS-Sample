...
SWIFT_CLASS("_TtC9MagnetSDK20MagnetAdInterstitial")
@interface MagnetAdInterstitial : NSObject
@property (nonatomic, readonly) BOOL isReady;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)loadRequestWithAdUnitId:(NSString * _Nonnull)uintId delegate:(id <MagnetEventsDelegate> _Nullable)delegate;
...
SWIFT_CLASS("_TtC9MagnetSDK14MagnetAdReward")
@interface MagnetAdReward : NSObject
@property (nonatomic, readonly) BOOL isReady;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)loadRequestWithAdUnitId:(NSString * _Nonnull)uintId delegate:(id <MagnetEventsDelegate> _Nullable)delegate;
- (void)presentWithRootViewController:(UIViewController * _Nonnull)rootViewController;
...
typedef SWIFT_ENUM(NSInteger, MagnetAdType) {
  MagnetAdTypeMobileBanner = 0,
  MagnetAdTypeMRect = 1,
  MagnetAdTypeInterstitial = 2,
  MagnetAdTypeReward = 3,
  MagnetAdTypeNative = 4,
  MagnetAdTypeNone = 5,
};
...
@protocol MagnetEventsDelegate
@optional
- (void)magnetAdErrorsWithCode:(NSInteger)code message:(NSString * _Nonnull)message adType:(enum MagnetAdType)adType;
- (void)magnetAdNativeDidReceiveWithMagnetAdNative:(MagnetAdNative * _Nonnull)magnetAdNative;
- (void)magnetAdInterstitialDidReceive;
- (void)magnetAdInterstitialDidClose;
- (void)magnetAdRewardDidReceive;
- (void)magnetAdRewardDidSuccessWithVerificationToken:(NSString * _Nonnull)verificationToken trackingId:(NSString * _Nonnull)trackingId;
- (void)magnetAdRewardDidFaild;
- (void)magnetAdRewardDidClose;
@end


@interface UIColor (SWIFT_EXTENSION(MagnetSDK))
@end


@interface UIDevice (SWIFT_EXTENSION(MagnetSDK))
@end


@interface UIResponder (SWIFT_EXTENSION(MagnetSDK))
@end
